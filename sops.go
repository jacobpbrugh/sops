...
command line client via `go get -u github.com/jacobpbrugh/sops/v3/cmd/sops`, or use the
decryption helper provided at `github.com/jacobpbrugh/sops/v3/decrypt`.

We do not guarantee API stability for any package other than `github.com/jacobpbrugh/sops/v3/decrypt`.
...
ordering.
*/
package sops // import "github.com/jacobpbrugh/sops/v3"
...
import (
	...
	"github.com/jacobpbrugh/sops/v3/audit"
	...
	"github.com/jacobpbrugh/sops/v3/shamir"
)
